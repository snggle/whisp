...
class _CartoonCloudState extends State<CartoonCloud> {
  ...
  void initState() {
    ...
    _positionChangeAnimation = Tween<double>(begin: 0.03, end: 0.25).animate(widget.expansionAnimationController)..addListener(_rebuild);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        children: <Widget>[
          Positioned(
            top: (MediaQuery.of(context).size.height * _positionChangeAnimation.value) + 50,
            left: 0,
            right: 0,
            child: Transform.scale(
              ...
              child: ClipRect(
                child: Align(
                  ...
                  child:
                      Opacity(opacity: _fadeInAnimation.value, child: widget.cloudMovingBool ? widget.themeAssets.cloudMoving : widget.themeAssets.cloudStill),
                ),
              ),
            ),
          ),
